...
|:-----------------------------------|:-------|:------|--------------------:|
| Запор-Для-Ворот ручка              | True   | True  |                  10 |
| Запор-Для-Ворот скоба-воротная     | True   | True  |                  10 |
| Запор-Для-Ворот скоба-центрирующая | True   | True  |                  10 |
| Запор-Для-Ворот улитка             | True   | True  |                  10 |
